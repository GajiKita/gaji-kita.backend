...
export class PayrollCyclesController {
  ...
  @ApiResponse({ status: 201, description: 'The payroll cycle has been successfully created.' })
  ...
  @ApiResponse({ status: 200, description: 'Return list of payroll cycles.' })
  ...
  @ApiResponse({ status: 200, description: 'Return payroll cycle details.' })
