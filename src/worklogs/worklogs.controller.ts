...
export class WorklogsController {
  ...
  @ApiResponse({ status: 201, description: 'The work log has been successfully created.' })
  ...
  @ApiResponse({ status: 200, description: 'Return list of work logs.' })
  ...
  @ApiResponse({ status: 200, description: 'The work log has been successfully approved. Returns blockchain sync data.' })
